...
namespace utility{
...
#if ((__GNUC__*100+__GNUC_MINOR__>=404 && __GXX_EXPERIMENTAL_CXX0X__) || _MSC_VER >= 1600) && (!__INTEL_COMPILER || __INTEL_COMPILER >= 1200) || __INTEL_LLVM_COMPILER
    ...
    template<typename T>
    void swap( smart_ptr<T>& ptr1, smart_ptr<T>& ptr2 ) {
        smart_ptr<T> tmp; tmp = ptr2; ptr2 = ptr1; ptr1 = tmp;
    }
#endif
