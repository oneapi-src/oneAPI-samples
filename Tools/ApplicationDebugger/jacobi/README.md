...
selection, buffer, accessor, and command groups.
...
batch or interactive mode.  For the jacobi sample, a node
...
```
$ ./jacobi-fixed cpu
[SYCL] Using device: [Intel(R) Core(TM) i7-7567U CPU @ 3.50GHz] from [Intel(R) OpenCL]
