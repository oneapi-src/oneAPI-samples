...
application with Intel&reg; Embree.

Use this code and accompanying walkthrough to understand construction of a basic
ray tracer and usage of the Intel&reg; Embree API. This sample prepares an API
explorer for further self-directed exploration of Intel&reg; Embree repository
tutorial programs. You can expect to need less than 5 minutes to compile, run,
...
This sample source code is a consolidated refactor of the `triangle_geometry`
