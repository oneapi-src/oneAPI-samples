...
|Deep Learning <br/> Inference Optimization|Intel® Extension for PyTorch | [Intel® Extension for PyTorch - Getting Started](https://github.com/intel/intel-extension-for-pytorch/blob/main/examples/cpu/inference/python/jupyter-notebooks/IPEX_Getting_Started.ipynb) | A simple training example for Intel® Extension of PyTorch.
