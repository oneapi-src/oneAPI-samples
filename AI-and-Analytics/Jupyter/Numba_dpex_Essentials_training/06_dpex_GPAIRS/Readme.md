## Title
 Gpairs Algorithm using numba-dpex: This is part 6 of the AI Numba-dpex essentials training series
...
## Purpose
These hands-on exercises show how to build a Numba implementation of Gpairs algorithm targeting CPU and GPU using Numba Jit approach, Kernel approach.
...
4. Navigate to AI_Analytics_Toolkit/Numba_dpex_Essentials folder and open the Welcome.ipynb, click on "Module 6 - dpex Gpairs" notebook and follow the instructions
