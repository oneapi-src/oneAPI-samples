...
!
! Content:
!     Implement edge detection on simple binary images and offload the
!     computation to a GPU using OpenMP target directives.
!
! Compile for CPU without OpenMP:
!     ifx img_seg_omp_target.F90 -o img_seg_cpu
!
! Compile for CPU with OpenMP:
!     ifx -qopenmp img_seg_omp_target.F90 -o img_seg_omp_cpu
!
! Compile for GPU using the OpenMP backend:
!     ifx img_seg_omp_target.F90 -o img_seg_omp_gpu \
!         -DOMP_TARGET -qopenmp -fopenmp-targets=spir64
!
!===============================================================================
program img_seg_omp_target
    implicit none
...
end program img_seg_omp_target
