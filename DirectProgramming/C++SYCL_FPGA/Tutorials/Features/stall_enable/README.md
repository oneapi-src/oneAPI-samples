...
> **Note**: The `use_stall_enable_clusters` attribute is not applicable for designs that target the Stratix® 10 architecture unless the `-Xshyper-optimized-handshaking=off` argument is passed to `icpx`
