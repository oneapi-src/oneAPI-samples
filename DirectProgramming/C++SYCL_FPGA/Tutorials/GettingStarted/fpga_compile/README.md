...
```
<img src="report_main_menu.png" height="500rem" alt='The Intel® oneAPI FPGA Report Main Menu, which includes a recently opened section and a getting started section with import file buttons.'/>

2. Import your design's reporting data .zip file (vector_add.report.prj/reports/vector_add_report.zip)

<img src="part2_report_example.png" height="500rem" alt='The summary page of the FPGA optimization report generated by running the report target for part 2.'/>
