...
// SystemVerilog created from i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_0gr
...
module IDAdder_i_llvm_fpga_sync_buffer_i32_000000r (
    ...
    wire [31:0] i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr_buffer_in;
    wire [31:0] i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr_buffer_out;


    // sync_out_3(GPOUT,6)@20000000
    assign out_stall_out = in_stall_in;

    // i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr(EXTIFACE,2)
    assign i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr_buffer_in = in_buffer_in;
    acl_dspba_buffer #(
        .WIDTH(32)
    ) thei_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr (
        .buffer_in(in_buffer_in),
        .buffer_out(i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr_buffer_out)
    );

    // sync_out_4(GPOUT,7)@1
    assign out_buffer_out = i_llvm_fpga_sync_buffer_i32_arg_a_sync_buffer_idadder_41_1gr_buffer_out;
