...
#include "../../whitepau.convolution2d/build_2024.1/conv.report.prj/include/register_map_offsets.h"
// IORD and IOWR
#include <io.h>
...
#define KERNEL_FINISH_COUNTER \
  (CONVOLUTION_BASE + ID_CONVOLUTION2D_REGISTER_MAP_FINISHCOUNTER_REG)
