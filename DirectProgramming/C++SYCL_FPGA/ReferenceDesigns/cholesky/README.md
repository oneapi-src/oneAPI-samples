...
>
> :warning: This code sample may fail to compile with the Intel® oneAPI
> DPC++/C++ Compiler 2024.2 due to a known bug which will be fixed in the
> 2024.2.1 patch. Users who wish to compile this code sample must make sure to
> have the 2024.2.1 patch of the oneAPI compiler installed.
