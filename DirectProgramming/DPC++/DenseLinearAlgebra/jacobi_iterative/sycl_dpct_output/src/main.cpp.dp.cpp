...
int main(int argc, char **argv) {
  ...
  sycl::queue *stream1;
/*
DPCT1025:17: The SYCL queue is created ignoring the flag and priority options.
*/
...
d_b = sycl::malloc_device<double>(N_ROWS, dpct::get_default_queue());
  ...
  sycl::free(d_x, dpct::get_default_queue());
  sycl::free(d_x_new, dpct::get_default_queue());
