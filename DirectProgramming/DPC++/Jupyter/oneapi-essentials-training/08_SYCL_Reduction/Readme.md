## Title
SYCL Reductions: This is part 8 of the oneAPI essentials training series
...
## Purpose
This hands-on exercise demonstrates various ways to optimizes reduction operations using SYCL. You will learn how to use ND-Range kernels to parallelize reductions on accelerators and also learn how to optimize reductions using new reduction extensions in SYCL.
