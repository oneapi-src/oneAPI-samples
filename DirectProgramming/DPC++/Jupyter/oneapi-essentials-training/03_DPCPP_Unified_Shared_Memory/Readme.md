## Title
 DPC++ Unified Shared Memory: This is part 3 of the oneAPI essentials training series
...
## Purpose
The hands-on exercises in this notebook show how to implement Unified Shared Memory (USM) in DPC++ code, as well as demonstrate implicit and explicit USM allocation and handling data dependency between tasks.
