...
4. Navigate to oneAPI_Essentials folder and open the Welcome.ipynb, click on "Module 1 - Introduction to oneAPI and DPC++" notebook and follow the instructions
