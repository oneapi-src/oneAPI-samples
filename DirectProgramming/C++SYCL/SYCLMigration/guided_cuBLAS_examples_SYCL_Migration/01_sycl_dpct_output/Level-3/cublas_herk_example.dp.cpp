...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:85: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    CUBLAS_CHECK(
        (oneapi::mkl::blas::column_major::herk(
             *cublasH, uplo, transa, n, k, alpha, (std::complex<double> *)d_A,
             lda, beta, (std::complex<double> *)d_C, ldc),
         0));
