...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:108: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    CUBLAS_CHECK(
        (oneapi::mkl::blas::column_major::syrk(*cublasH, uplo, transa, n, k,
                                               alpha, d_A, lda, beta, d_C, ldc),
         0));
