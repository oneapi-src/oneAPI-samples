...
int main(int argc, char *argv[]) try {
    ...
    */
    ...
    /* step 3: compute */
    /*
    DPCT1034:61: Migrated API does not return error code. 0 is returned in the
    lambda. You may need to rewrite this code.
    */
  CUBLAS_CHECK([&]() {
    double *res_temp_ptr_ct7 = &result;
    ...
    oneapi::mkl::blas::column_major::dot(*cublasH, A.size(), d_A, incx, d_B,
                                         incy, res_temp_ptr_ct7);
    if (sycl::get_pointer_type(&result, cublasH->get_context()) !=
            sycl::usm::alloc::device &&
        sycl::get_pointer_type(&result, cublasH->get_context()) !=
            sycl::usm::alloc::shared) {
