...
int main(int argc, char *argv[]) try {
    ...
    /*
    DPCT1003:128: Migrated API does not return error code. (*, 0) is inserted.
    ...
    */
    /*
    DPCT1025:130: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::tpmv(
                      *cublasH, uplo, transa, diag, n, d_AP, d_x, incx),
                  0));
