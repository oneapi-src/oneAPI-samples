## Title
 SYCL Unified Shared Memory: This is part 3 of the oneAPI essentials training series
...
## Purpose
The hands-on exercises in this notebook show how to implement Unified Shared Memory (USM) in SYCL code, as well as demonstrate implicit and explicit USM allocation and handling data dependency between tasks.
...
4. Navigate to oneAPI_Essentials folder and open the Welcome.ipynb, click on "Module 3 - SYCL Unified Shared Memory" notebook and follow the instructions
