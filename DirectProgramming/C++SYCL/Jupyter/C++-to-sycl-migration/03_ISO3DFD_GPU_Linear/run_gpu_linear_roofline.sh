...
advisor --collect=survey --profile-gpu -project-dir=./roofline_linear -- ./build/src/3_GPU_linear 256 256 256 100
advisor --collect=tripcounts --profile-gpu --project-dir=./roofline_linear -- ./build/src/3_GPU_linear 256 256 256 100
