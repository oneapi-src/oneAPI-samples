...
This DPC++ reference design demonstrates a highly optimized adaptive noise reduction (ANR) algorithm on an FPGA.
...
|`qfp_pow2_lut.hpp`               | A ROM LUT for computing x^2 on a 32-bit floating-point value (using a QFP).
