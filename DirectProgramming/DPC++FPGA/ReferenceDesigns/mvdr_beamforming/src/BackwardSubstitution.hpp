...
template <
  typename  BackwardSubstitutionKernelName,   // Name to use for the Kernel
  ...
  typename  UDiagRecipVectorInPipe,   // Receive 1/ the diagonal elements of U.
      ...
      while( 1 ) {
        ...
        for( char vector_num = 0; vector_num < (char)k_num_y_vectors;
          ...
          for( short i = 0 ; i < (short)k_vector_size; i++ ){
            ...
            y_vector_initial[i/k_unroll_factor][i%k_unroll_factor] = y_pipe_in;
