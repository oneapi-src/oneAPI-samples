...
template <size_t k_instance_num> class InputDemux;
...
// mangling
template <size_t k_instance_num> class TrainingDataPipeID;
template <size_t k_instance_num> class XrxDataPipeID;
...
template <size_t k_instance_num> class TransposedTrainingDataPipeID;
template <size_t k_instance_num> class TrainingDataDupPipeID;
template <size_t k_instance_num> class XrxDataDupPipeID;
template <size_t k_instance_num> class SteeringVectorsDupPipeID;
template <size_t k_instance_num> class ForwardSteeringVectorsDupPipeID;
template <size_t k_instance_num> class RMatrixDupPipeID;
template <size_t k_instance_num> class RDiagRecipVectorDupPipeID;
template <size_t k_instance_num> class ForwardSubstitutionResultDupPipeID;
template <size_t k_instance_num> class YVectorsDupPipeID;
template <size_t k_instance_num> class WeightVectorsDupPipeID;
template <size_t k_instance_num> class TransposedTrainingDataDupPipeID;
...
template <
  ...
  typename TrainingDataPipeOut = PipeDuplicator<MVDRNullPipeID, 
    NTuple< ComplexType, k_num_complex_per_xrx_read>>,
  typename XrxDataPipeOut = PipeDuplicator<MVDRNullPipeID, 
    NTuple< ComplexType, k_num_complex_per_xrx_read>>,
  typename SteeringVectorsPipeOut = PipeDuplicator<MVDRNullPipeID, 
    ComplexType>,
  typename ForwardSteeringVectorsPipeOut = PipeDuplicator<MVDRNullPipeID,
    ComplexType>,
  typename RMatrixPipeOut = PipeDuplicator<MVDRNullPipeID,
    ComplexType>,
  typename RDiagRecipVectorPipeOut = PipeDuplicator<MVDRNullPipeID,
    float>,
  typename ForwardSubstitutionResultPipeOut = PipeDuplicator<MVDRNullPipeID,
    ComplexType>,
  typename YVectorsPipeOut = PipeDuplicator<MVDRNullPipeID,
    ComplexType>,
  typename WeightVectorsPipeOut = PipeDuplicator<MVDRNullPipeID,
    ComplexType>,
  typename TransposedTrainingDataPipeOut = PipeDuplicator<MVDRNullPipeID,
    NTuple< ComplexType, k_num_complex_per_xrx_read>>
>
MVDREventArray SubmitMVDRKernels( 
  ...
  constexpr int kTrainingDataPipeMinDepth = kTrainingMatrixSize / 
                                            k_num_complex_per_xrx_read;
  using TrainingDataPipe = sycl::INTEL::pipe< 
    TrainingDataPipeID<k_instance_num>,
    XrxPipeType, kTrainingDataPipeMinDepth >;
  using TrainingDataDupPipe = PipeDuplicator<
    TrainingDataDupPipeID<k_instance_num>,
    XrxPipeType,
    TrainingDataPipe,
    TrainingDataPipeOut>;

  // Xrx processing data pipe and duplicator (after demux from input data)
  constexpr int kXrxDataPipeMinDepth =  kTrainingMatrixSize / 
                                        k_num_complex_per_xrx_read;
  ...
  using SteeringVectorsDupPipe = PipeDuplicator<
    SteeringVectorsDupPipeID<k_instance_num>,
    ComplexType,
    SteeringVectorsPipe,
  ...
  using ForwardSteeringVectorsPipe = sycl::INTEL::pipe<
    ...
    ComplexType, kSteeringVectorsPipeMinDepth >;
  using ForwardSteeringVectorsDupPipe = PipeDuplicator<
    ForwardSteeringVectorsDupPipeID<k_instance_num>,
    ComplexType,
    ForwardSteeringVectorsPipe,
  ...
  using RMatrixDupPipe = PipeDuplicator<
    RMatrixDupPipeID<k_instance_num>,
    ComplexType,
    RMatrixFSPipe,
    RMatrixBSPipe,
    RMatrixPipeOut>;
  ...
  using RDiagRecipVectorDupPipe = PipeDuplicator<
    RDiagRecipVectorDupPipeID<k_instance_num>,
    float,
    RDiagRecipVectorFSPipe,
  ...
  using ForwardSubstitutionResultDupPipe = PipeDuplicator<
    ForwardSubstitutionResultDupPipeID<k_instance_num>,
    ComplexType,
    ForwardSubstitutionResultPipe,
  ...
  using YVectorsDupPipe = PipeDuplicator< YVectorsDupPipeID<k_instance_num>,
  ...
  using WeightVectorsDupPipe = PipeDuplicator<
    WeightVectorsDupPipeID<k_instance_num>,
    ComplexType,
    WeightVectorsPipe,
  ...
  using QMatrixPipe = PipeDuplicator< QMatrixPipeID<k_instance_num>,
                                      QMatrixColumn >;

  // transposed training data pipe
  constexpr int kTransposedTrainingDataPipeMinDepth = kTrainingDataPipeMinDepth;
  using TransposedTrainingDataPipe = sycl::INTEL::pipe< 
    TransposedTrainingDataPipeID<k_instance_num>, 
    XrxPipeType, kTransposedTrainingDataPipeMinDepth >;
  using TransposedTrainingDataDupPipe = PipeDuplicator<
    TransposedTrainingDataDupPipeID<k_instance_num>, 
    XrxPipeType,
    TransposedTrainingDataPipe,
  ...
  events[static_cast<int>(MVDRKernelNames::forward_substitution)] = 
    SubmitForwardSubstitutionKernel<
      ...
      ForwardSteeringVectorsDupPipe,  // Steering vectors used to calculate X
