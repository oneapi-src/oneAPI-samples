...
The type also provides two more optional parameters for controlling the overflow and rounding modes. For more details on the type, please refer to the section *Variable-Precision Integer and Floating-Point Support* in the Intel® oneAPI DPC++ FPGA Optimization Guide.
