...
1. Generate the `Makefile` by running `cmake`.
  ...
  ```
   ...
   ```
   cmake .. -DFPGA_TARGET=intel_s10sx_pac:pac_s10 -DNO_HYPER_OPTIMIZATION=true
   ```
...
1. Generate the `Makefile` by running `cmake`.
   ...
   ```
   cmake -G "NMake Makefiles" .. -DFPGA_TARGET=intel_s10sx_pac:pac_s10 -DNO_HYPER_OPTIMIZATION=true
   ```
