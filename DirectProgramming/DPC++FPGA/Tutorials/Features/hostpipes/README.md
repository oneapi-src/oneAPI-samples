...
| Hardware                          | Intel® FPGA Programmable Acceleration Card (PAC) D5005 (with Intel Stratix® 10 SX) *__Note__: Intel® FPGA PAC hardware is only compatible with Ubuntu 18.04*
