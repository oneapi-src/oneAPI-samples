...
A test compile of this tutorial design achieved an f<sub>MAX</sub> of approximately 250 MHz on the Intel&reg; Programmable Acceleration Card with Intel&reg; Arria&reg; 10 GX FPGA. The results are shown in the following table:
