# Intel&reg; oneAPI Deep Neural Network Library (oneDNN)

oneAPI Deep Neural Network Library (oneDNN) is an open-source performance library for deep learning applications. The library includes basic building blocks for neural networks optimized for Intel&reg; Architecture Processors and Intel&reg; Processor Graphics. oneDNN is intended for deep learning applications and framework developers interested in improving application performance on Intel&reg; CPUs and GPUs
...
| Component | [Intel&reg; vTune&trade; profiling](tutorial_vtune_profiling.ipynb) | This Jupyter Notebook demonstrates how to use VTune&trade; Profiler to profile oneDNN samples and find out performance bottlenecks. |
>  Notice : Please use Intel&reg; oneAPI DevCloud as the environment for jupyter notebook samples. \
