...
int main(int argc, char *argv[]) try {
  ...
  oneapi::mkl::blas::column_major::gemm(
      *cublasH, transa, transb, m, n, k,
      std::complex<float>(alpha.x(), alpha.y()), (std::complex<float> *)d_A,
      lda, (std::complex<float> *)d_B, ldb,
      std::complex<float>(beta.x(), beta.y()), (std::complex<float> *)d_C, ldc);
