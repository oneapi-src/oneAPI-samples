...
int main(int argc, char *argv[]) try {
  ...
  stream->memcpy(d_y, y.data(), sizeof(data_type) * y.size());

  /* step 3: compute */
  oneapi::mkl::blas::column_major::hpr2(
      *cublasH, uplo, n, std::complex<double>(alpha.x(), alpha.y()),
      (std::complex<double> *)d_x, incx, (std::complex<double> *)d_y, incy,
      (std::complex<double> *)d_AP);

  /* step 4: copy data to host */
  stream->memcpy(AP.data(), d_AP, sizeof(data_type) * AP.size());
