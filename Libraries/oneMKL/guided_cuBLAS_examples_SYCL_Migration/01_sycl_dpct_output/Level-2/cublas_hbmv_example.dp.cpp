...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:43: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    CUBLAS_CHECK(
        (oneapi::mkl::blas::column_major::hbmv(
             *cublasH, uplo, n, k, std::complex<double>(alpha.x(), alpha.y()),
             (std::complex<double> *)d_A, lda, (std::complex<double> *)d_x,
             incx, std::complex<double>(beta.x(), beta.y()),
             (std::complex<double> *)d_y, incy),
         0));
