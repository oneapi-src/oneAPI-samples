...
int main(int argc, char *argv[]) try {
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::trsv(
                      *cublasH, uplo, transa, diag, n, d_A, lda, d_x, incx),
                  0));
    ...
    /*
    DPCT1003:146: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
