...
int main(int argc, char *argv[]) try {
    ...
    */
    ...
    /*
    DPCT1025:86: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::rotm(
                      *cublasH, A.size(), d_A, incx, d_B, incy,
                      const_cast<double *>(param.data())),
                  0));
