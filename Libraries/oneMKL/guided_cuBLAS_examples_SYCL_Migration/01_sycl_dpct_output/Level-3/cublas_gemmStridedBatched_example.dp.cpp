...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:60: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    CUBLAS_CHECK(
        (oneapi::mkl::blas::column_major::gemm_batch(
             *cublasH, transa, transb, m, n, k, alpha, d_A, lda, strideA, d_B,
             ldb, strideB, beta, d_C, ldc, strideC, batch_count),
         0));
