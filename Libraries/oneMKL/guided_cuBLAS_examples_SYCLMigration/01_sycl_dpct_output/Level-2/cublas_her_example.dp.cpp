...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:66: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::her(
                      *cublasH, uplo, n, alpha, (std::complex<double> *)d_x,
                      incx, (std::complex<double> *)d_A, lda),
                  0));
