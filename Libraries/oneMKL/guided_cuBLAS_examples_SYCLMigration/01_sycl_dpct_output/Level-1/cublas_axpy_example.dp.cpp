...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:24: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::axpy(
                      *cublasH, A.size(), alpha, d_A, incx, d_B, incy),
                  0));
