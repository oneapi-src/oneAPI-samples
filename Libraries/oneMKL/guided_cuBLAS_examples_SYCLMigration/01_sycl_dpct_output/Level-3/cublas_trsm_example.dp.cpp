...
int main(int argc, char *argv[]) try {
    ...
    */
    /*
    DPCT1025:135: The SYCL queue is created ignoring the flag and priority
    options.
    */
    ...
    */
    ...
    You may need to rewrite this code.
    */
    CUBLAS_CHECK((oneapi::mkl::blas::column_major::trsm(
                      *cublasH, side, uplo, transa, diag, m, n, alpha, d_A, lda,
                      d_B, ldb),
                  0));

    /* step 4: copy data to host */
    CUDA_CHECK(
        (stream->memcpy(B.data(), d_B, sizeof(data_type) * B.size()), 0));
