...
void run_on_device(const int &n, const unsigned long long &offset,
  ...
  /*
  DPCT1033:20: Migrated code uses a basic Sobol generator. Initialize
...
void run_on_host(const int &n, const unsigned long long &offset,
  ...
  /* Create quasi-random number generator */
  /*
  DPCT1033:22: Migrated code uses a basic Sobol generator. Initialize
  oneapi::mkl::rng::sobol generator with user-defined direction numbers to use
  it as Scrambled Sobol generator.
  */
  CURAND_CHECK(DPCT_CHECK_ERROR(
...
int main(int argc, char *argv[]) try {
  ...
  /*
  DPCT1033:24: Migrated code uses a basic Sobol generator. Initialize
  oneapi::mkl::rng::sobol generator with user-defined direction numbers to use
  it as Scrambled Sobol generator.
  */
